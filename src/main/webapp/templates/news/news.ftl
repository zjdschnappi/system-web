...
<script type="text/javascript" src="/system-web/JS/newsContent.js"></script>
<title>新闻</title>
</head>
<body>
<div class="navbar">
	<img alt="平台logo" src="/system-web/IMG/logo.png"
	...
	<div id="article_area">
			<div id="article_left_btn">
				<ul class="article_left_btn_ul">
					<li><a><span>&nbsp;</span><img
							src="/system-web/IMG/iconfont-pinglun.png"> </a></li>
					<li><a><span>&nbsp;</span><img
							src="/system-web/IMG/iconfont-qq.png"> </a></li>
					<li><a><span>&nbsp;</span><img
							src="/system-web/IMG/iconfont-kongjian.png"> </a></li>
					<li><a><span>&nbsp;</span><img
							src="/system-web/IMG/iconfont-xinlang.png"> </a></li>
					<li><a><span>&nbsp;</span><img
							src="/system-web/IMG/iconfont-weixin.png"> </a></li>
				</ul>
			</div>
	</div>
	</div>
